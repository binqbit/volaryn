...
- **Activity** (`/portfolio/activity`) retains pending, completed, failed, and interrupted operations. Pending creations appear in **All** and **My offers** before finalization. The wallet reconnects after reload when its permission remains valid; **Disconnect** clears that preference. See the [offer lifecycle](docs/offer-lifecycle.md) for transaction states, persistence, and recovery.
