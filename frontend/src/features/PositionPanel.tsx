...
import { useWalletLayout } from './useWalletLayout';
...
export function PositionPanel({
  ...
  return (
    <section ref={panel} id="wallet" className={styles.position} aria-labelledby="position-title">
      <div ref={pinned} className={styles.walletPinned}>
